<template>
  <div class="box">
    ...
    <!-- 临时测试内容 start -->
    <Button name="父组件isShow" @click="isShow = !isShow"></Button>
    <test v-model="isShow" v-model:text="textVModel"></test>
    <div>父组件：{{ isShow }} -- {{ textVModel }}</div>
    ...
    <transition :duration="{ enter: 500, leave: 500 }" enter-active-class="animate__animated animate__bounceInRight"
...
const textVModel = ref<string>("dilei")
